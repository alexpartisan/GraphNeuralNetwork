...
DATA_DIR = '/home/alexpartisan/Work/Data/Competition/CHAMP/input/champs-scalar-coupling'
...
def run_convert_to_graph(graph_dir):
...
# # def run_make_split():
# #
# #     split_dir = '/home/alexpartisan/Work/Data/Competition/CHAMP/input/split'
# #
...
def run_make_split():
    ...
    for i, (trn_ind, val_ind) in enumerate(kf.split(molecule_names)):
        num_train = len(trn_ind)
        num_valid = len(val_ind)
        train_split = molecule_names[trn_ind]
        valid_split = molecule_names[val_ind]
        np.save(split_dir + '/train_split_by_mol_{}_{}.npy'.format(i, num_train), train_split)
        np.save(split_dir + '/valid_split_by_mol_{}_{}.npy'.format(i, num_valid), valid_split)
...
if __name__ == '__main__':
    ...
    GRAPH_DIR = '/home/alexpartisan/Work/Data/Competition/CHAMP/input/graph'
    # run_convert_to_graph(GRAPH_DIR)#
